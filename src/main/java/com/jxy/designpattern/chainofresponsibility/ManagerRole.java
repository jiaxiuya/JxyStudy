 ...
 * @since [产品/模块版本]
 */
public class ManagerRole extends AbstractApproveRole {

    public ManagerRole(String name) {
        super(name);
    }
    ...
    void doApprove(LeaveBill leaveBill) {
        ...
        if (endTime - startTime > 3 * 24 * 3600 * 1000 && endTime - startTime < 6 * 24 * 3600 * 1000) {
