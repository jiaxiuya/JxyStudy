 ...
 */
package com.jxy.jstorm.sequence;
...
import com.jxy.jstorm.sequence.bean.Pair;
import com.jxy.jstorm.sequence.bean.TradeCustomer;
import com.jxy.jstorm.sequence.bolt.MergeRecord;
import com.jxy.jstorm.sequence.bolt.PairCount;
import com.jxy.jstorm.sequence.bolt.SplitRecord;
import com.jxy.jstorm.sequence.bolt.TotalCount;
import com.jxy.jstorm.sequence.kryo.PairSerializer;
import com.jxy.jstorm.sequence.kryo.TradeCustomerSerializer;
import com.jxy.jstorm.sequence.spout.SequenceSpout;
...
public class SequenceTopology {
    ...
    public static void SetDPRCTopology() throws AlreadyAliveException,
        ...
        System.out.println("Please refer to com.alipay.dw.com.jxy.jstorm.drpc.ReachTopology");
    }
